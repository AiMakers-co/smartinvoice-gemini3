...
const statusConfig = {
  pending: { label: "Pending", icon: Clock, color: "text-amber-500 bg-amber-50 border border-amber-100" },
  pending_extraction: { label: "Processing", icon: Clock, color: "text-blue-500 bg-blue-50 border border-blue-100" },
  completed: { label: "Completed", icon: CheckCircle, color: "text-emerald-500 bg-emerald-50 border border-emerald-100" },
  failed: { label: "Failed", icon: AlertTriangle, color: "text-red-500 bg-red-50 border border-red-100" },
};
...
function StatementCard({
  ...
  return (
    <div className="bg-white rounded-lg border border-slate-200 shadow-sm p-4 hover:border-slate-300 transition-all">
      {/* Header */}
      <div className="flex items-center gap-3 mb-3">
        ...
        <div className="flex-1 min-w-0">
          <p className="font-semibold font-mono text-sm text-slate-900 truncate">{statement.originalFileName}</p>
      ...
      <div className="flex flex-wrap gap-1.5 mb-3">
        {pills.map((pill, idx) => {
          ...
          return (
            <span
              key={idx}
              className={`inline-flex items-center gap-1 px-2 py-0.5 rounded-md border text-[10px] font-mono ${colors.bg} ${colors.text} ${colors.border}`}
            >
              <span className="font-medium uppercase tracking-wide">{pill.label}:</span>
      ...
      {/* Actions */}
      <div className="flex items-center gap-1.5 pt-2 border-t border-slate-100 font-mono">
        <Button
          variant="ghost"
          size="sm"
          onClick={onView}
    ...
    <div className="mb-5">
      ...
      >
        ...
        <div className="text-left flex-1 min-w-0">
          <p className="font-semibold font-mono text-sm text-slate-900 uppercase tracking-wide">{account.bankName}</p>
        ...
        <Badge variant="secondary" className="bg-slate-50 border border-slate-200 text-slate-500 text-[10px] font-mono">
      ...
      <DialogContent className="max-w-[90vw] max-h-[90vh] w-full h-[90vh] overflow-hidden flex flex-col">
        <DialogHeader>
          <DialogTitle className="flex items-center gap-2">
            ...
            <div>
              <span className="block font-mono tracking-wide">{statement.account?.bankName || statement.originalFileName}</span>
          ...
          <div className="grid grid-cols-2 gap-4 flex-1 min-h-0">
            ...
            <div className="bg-white border border-slate-200 rounded-lg shadow-sm overflow-hidden flex flex-col">
              <div className="px-3 py-2 bg-slate-50 border-b border-slate-100">
                <span className="text-xs font-medium font-mono uppercase tracking-wide text-slate-500">Original Document</span>
              </div>
            ...
            <div className="bg-white border border-slate-200 rounded-lg shadow-sm overflow-hidden flex flex-col">
              <div className="px-3 py-2 bg-slate-50 border-b border-slate-100 flex items-center justify-between">
                <span className="text-xs font-medium font-mono uppercase tracking-wide text-slate-500">
                ...
                {loadingTxns ? (
                  ...
                  <table className="w-full text-xs font-mono">
                    <thead className="bg-slate-50 sticky top-0 border-b border-slate-100">
                      <tr>
                        <th className="px-2 py-1.5 text-left font-medium text-slate-400 uppercase tracking-wide whitespace-nowrap">Date</th>
                        <th className="px-2 py-1.5 text-left font-medium text-slate-400 uppercase tracking-wide whitespace-nowrap">Description</th>
                        <th className="px-2 py-1.5 text-right font-medium text-slate-400 uppercase tracking-wide whitespace-nowrap">Amount</th>
                        <th className="px-2 py-1.5 text-right font-medium text-slate-400 uppercase tracking-wide whitespace-nowrap">Balance</th>
                      </tr>
                    </thead>
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-lg font-semibold font-mono uppercase tracking-wide text-slate-900">Bank Statements</h2>
          <p className="text-xs text-slate-400 font-mono">Upload and manage your bank statements</p>
        </div>
      ...
      <div className="bg-white border border-slate-200 rounded-lg shadow-sm">
        <div className="flex items-center divide-x divide-slate-100">
          <div className="px-3 py-2">
            <div className="text-[9px] uppercase tracking-wider text-slate-400 font-medium font-mono">Total</div>
            <div className="text-base font-bold font-mono">0</div>
          </div>
          <div className="px-3 py-2">
            <div className="text-[9px] uppercase tracking-wider text-slate-400 font-medium font-mono">Transactions</div>
            <div className="text-base font-bold font-mono">0</div>
          </div>
          <div className="px-3 py-2">
            <div className="text-[9px] uppercase tracking-wider text-slate-400 font-medium font-mono">Accounts</div>
            <div className="text-base font-bold font-mono">0</div>
          </div>
          <div className="px-3 py-2">
            <div className="text-[9px] uppercase tracking-wider text-slate-400 font-medium font-mono">Size</div>
            <div className="text-base font-bold font-mono">0 KB</div>
          </div>
        </div>
      </div>
      ...
      <Card className="bg-white border border-slate-200 rounded-lg shadow-sm">
        <CardContent className="p-8 text-center">
          <div className="h-12 w-12 rounded-full bg-slate-50 border border-slate-200 flex items-center justify-center mx-auto mb-3">
            <FileText className="h-6 w-6 text-slate-400" />
          </div>
          <p className="text-sm font-medium font-mono text-slate-900 mb-1">No statements yet</p>
          <p className="text-xs text-slate-400 font-mono mb-4">Upload a bank statement to extract transactions automatically</p>
            ...
            <div className="bg-white border border-slate-200 rounded-lg shadow-sm">
              <div className="flex items-center divide-x divide-slate-100">
                <div className="flex-1 px-3 py-2">
                  <div className="text-[9px] uppercase tracking-wider text-slate-400 font-medium font-mono">Statements</div>
                  <div className="text-base font-bold font-mono">{totalStatements}</div>
                </div>
                <div className="flex-1 px-3 py-2">
                  <div className="text-[9px] uppercase tracking-wider text-slate-400 font-medium font-mono">Transactions</div>
                  <div className="text-base font-bold font-mono">{totalTransactions.toLocaleString()}</div>
                </div>
                <div className="flex-1 px-3 py-2">
                  <div className="text-[9px] uppercase tracking-wider text-slate-400 font-medium font-mono">Accounts</div>
                  <div className="text-base font-bold font-mono">{uniqueAccounts}</div>
                </div>
                <div className="flex-1 px-3 py-2">
                  <div className="text-[9px] uppercase tracking-wider text-slate-400 font-medium font-mono">Total Size</div>
                  <div className="text-base font-bold font-mono">{formatFileSize(totalSize) || "—"}</div>
                </div>
                <div className="px-3 py-2">
